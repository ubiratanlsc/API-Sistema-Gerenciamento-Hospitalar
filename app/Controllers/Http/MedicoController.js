...
/**
 * Resourceful controller for interacting with medicos
 */
...
class MedicoController {
  ...
  /**
   * Render a form to be used for creating a new medico.
   * GET medicos/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
  ...
  /**
   * Render a form to update an existing medico.
   * GET medicos/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
